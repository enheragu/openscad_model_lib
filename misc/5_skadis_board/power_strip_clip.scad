...
clip_power_strip_heigth = power_strip_heigth + clip_wall*2 + tolerance*2;
...
{   
    difference()
    {
        ...
        union()
        {
            filleted_rectangle(power_strip_length,power_strip_heigth,power_strip_width, power_strip_round_corner_rad);

            translate([power_strip_length, power_strip_heigth/2,power_strip_width/2])
            rotate([0,90,0])
            cylinder(d = power_strip_cable_diameter, h = 17, $fn = fn);
        }

        // Switch
        translate([power_strip_length-25-25, power_strip_heigth/2 - 31/2, power_strip_width - 2])
        filleted_rectangle(25,31,2.1, 3);

        // USB plugs
        translate([25, power_strip_heigth/2 - 46/2, power_strip_width - 2])
...
module power_strip_negative()
{
    ...
    n_power_strip_heigth = power_strip_heigth+tolerance*2;
    ...
    union()
    {
        ...
        union()
        {
            filleted_rectangle(n_power_strip_length,n_power_strip_heigth,n_power_strip_width, power_strip_round_corner_rad);

            translate([n_power_strip_length, n_power_strip_heigth/2,n_power_strip_width/2])
            rotate([0,90,0])
            cylinder(d = power_strip_cable_diameter, h = 17, $fn = fn);
        }
        ...
        translate([25, power_strip_heigth/2 - n_usb_y/2, n_power_strip_width - 2])
...
module clip_1()
{
    ...
    difference()
    {
        filleted_rectangle(clip_power_strip_length,clip_power_strip_heigth,clip_power_strip_width, power_strip_round_corner_rad);

        translate([clip_wall,clip_wall,clip_wall_bottom])
        power_strip_negative();

        // USB plugs
        translate([25-tolerance, clip_power_strip_heigth/2 - 50/2, clip_power_strip_width - clip_wall - 0.1])
...
module clip_2()
{
    ...
    difference()
    {
        ...
        difference()
        {
            ...
            translate([-0.1,clip_power_strip_heigth/2-cable_hole_y/2-0.1,-0.1])
            cube([clip_power_strip_length + 0.2,cable_hole_y, cable_hole_z]);    

            translate([clip_power_strip_length - clip_wall - 0.1, clip_power_strip_heigth/2,clip_power_strip_width/2])
            rotate([0,90,0])
