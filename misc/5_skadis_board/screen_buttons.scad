...
module board(translation = [0,0,0])
{
    ...
    union()
    {
        ...
        // Buttons
        but_translate_1 = [5.8,9.1,keypad_width]; button(but_translate_1);
        but_translate_2 = but_translate_1 + [0,button_side+15.66,0]; button(but_translate_2);
        but_translate_3 = but_translate_2 + [0,button_side+11.74,0]; button(but_translate_3);
        but_translate_4 = but_translate_3 + [0,button_side+11.74,0]; button(but_translate_4);
        but_translate_5 = but_translate_4 + [0,button_side+11.74,0]; button(but_translate_5);
